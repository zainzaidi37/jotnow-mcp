...
// `node:sqlite`.
//
// `locking_mode = EXCLUSIVE` plus an open transaction and one read is what
...
// the plan's §1). The protocol: `held` once the lock is taken; then the holder
...
const [dbPath, releaseAfter] = process.argv.slice(2);
